...
int main(void) {
  ...
  while (1) {
    ...
    tx_data.data[0] = D2.Byte;
    tx_data.data[1] = D3.Byte;

    tx_data.data[4] = D2.Byte;
    tx_data.data[5] = D2.Byte;
    tx_data.data[6] = D3.Byte;
    tx_data.data[7] = D3.Byte;
    tx_data.crc = calculate_crc8_real(tx_data.data, 8);
# 162 "main.c"
